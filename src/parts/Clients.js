        ...
        <div className="container">
          <div className="clients-inner section-inner has-top-divider has-bottom-divider">
            <ul className="list-reset">
              <li>
                <img src={Client1} alt="Clients 01" />
              </li>
              <li>
                <img src={Client2} alt="Clients 02" />
              </li>
              <li>
                <img src={Client3} alt="Clients 03" />
              </li>
              <li>
                <img src={Client4} alt="Clients 04" />
              </li>
              <li>
                <img src={Client5} alt="Clients 05" />
              </li>
            </ul>
          </div>
        </div>
